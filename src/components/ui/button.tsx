  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        academic: "bg-gradient-primary text-white shadow-soft hover:shadow-medium hover:scale-105 transition-bounce",
        role: "bg-academic-blue-light text-academic-blue border-2 border-academic-blue/20 hover:bg-academic-blue hover:text-white hover:border-academic-blue transition-smooth",
        submit: "bg-academic-success text-white hover:bg-academic-success/90 shadow-soft hover:shadow-medium transition-smooth",
      },
      size: {
